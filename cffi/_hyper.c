...
static double _cffi_d_hyp2f1x(double x0, double x1, double x2, double x3)
{
  return hyp2f1x(x0, x1, x2, x3);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_hyp2f1x(PyObject *self, PyObject *args)
{
  double x0;
  double x1;
  double x2;
  ...
  if (!PyArg_UnpackTuple(args, "hyp2f1x", 4, 4, &arg0, &arg1, &arg2, &arg3))
    return NULL;
...
#else
#  define _cffi_f_hyp2f1x _cffi_d_hyp2f1x
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "hyp2f1x", (void *)_cffi_f_hyp2f1x, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_hyp2f1x },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__hyper(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__hyper(void) { return NULL; }
#  else
     init_hyper(void) { }
#  endif
#  endif
...
PyInit__hyper(void)
{
  return _cffi_init("_hyper", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_hyper(void)
{
  _cffi_init("_hyper", 0x2601, &_cffi_type_context);
}
#endif
